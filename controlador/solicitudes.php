    ...
    <ul>
           ...
           <table>
               ...
               <tr align="center">   
                  <td>
                    ...
                    De: <input type="text" name="duracion" readonly="readonly" id="duracion" value="'.date('d-m-Y',strtotime($solicitud['inicioDSolici'])).'" /> A: <input type="text" name="duracion" readonly="readonly" id="duracion" value="'.date('d-m-Y',strtotime($solicitud['finDSolici'])).'" />
                  </td>
                </tr>
           </table>
          </div>
        ...
        <div id="hoja2">
                ...
                <p>
                  ...
                  <input type="text" name="fechaRequi" readonly="readonly" id="fechaRequi" style="width:130px;" value="'.date('d-m-Y',strtotime($solicitud['iniSolici'])).'" />
                </p>

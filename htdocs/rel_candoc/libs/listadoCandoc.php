...
<script type="text/javascript" language="javascript" src="js/jslistadoEsc.js"></script> <!--GMM001- Cambiar nombre del Archivo-->
   ...
   <tbody>
      <?php
         while($reg=  mysql_fetch_array($queryB))
         {
            ...
            echo '<td width="10%"><center>'.mb_convert_encoding($reg['idEscolar'], "UTF-8").'</center></td>';
            echo '<td width="50%">'.mb_convert_encoding($reg['nomEscolar'], "UTF-8").'</td>';            
